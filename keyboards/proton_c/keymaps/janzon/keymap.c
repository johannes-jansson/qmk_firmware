...
#define KC_GMESC LT(_GFN2, KC_ESC)
...
[_SYM] = LAYOUT_ortho_4x12( \
    ...
    KC_SE_PIPE,    KC_HASH,   KC_PERC, KC_SE_LBRC, KC_SE_RBRC, KC_SE_DQUO, KC_SE_COLN,    KC_1,      KC_2,    KC_3, KC_SE_BSLS,KC_WIN_BSLS, \
         RESET,  TO(_GAME2),   _______,    _______,    _______,    _______,    _______, _______,      KC_0, _______,    _______,    _______  \
),
...
[_SYS] = LAYOUT_ortho_4x12(
   ...
   TO(_GAME2),KC_MRWD, KC_MPLY, KC_MFFD, MY_SCREENSHOT, _______,        KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, _______, _______, \
...
[_GAME2] = LAYOUT_ortho_4x12(
     _______, _______, KC_GMESC,    KC_1,    KC_2,    KC_3,    KC_4,     KC_5,    TO(_QWERTY), _______, _______, _______, \
...
[_GFN2] = LAYOUT_ortho_4x12(
    _______,  _______, _______,   KC_F1,   KC_F1, KC_SWLBRC,      KC_M,     KC_SLSH,    _______, _______, _______, _______, \
